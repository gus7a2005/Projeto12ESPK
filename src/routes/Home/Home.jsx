        ...
        <div className="relative w-96 m-6 cursor-pointer border-2 shadow-lg rounded-xl items-center">
            <div className="flex h-28 bg-red-200 rounded-xl items-center justify-center">
                ...
                <div className="p-2 border-b-2">
                    <h6>
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Illo, at! Lorem ipsum dolor sit amet.

                    </h6>

                    <div className="flex flex-wrap items-center m-2">
                        <span className="border border-red-950 rounded-xl px-2 my-1 mx-1">
                            #React 
                        </span>
                    ...
                    <div className="flex flex-wrap items-center rounded-b-xl border-t-2 bg-red-200">
                        <button className="border rounded-2xl bg-red-600 text-red-100 shadow-sm p-1 px-2 m-2 hover:bg-green-700">
                            Projetos
                        </button>
                        <button className="border rounded-2xl bg-red-600 text-red-100 shadow-sm p-1 px-2 m-2 hover:bg-green-700">
                            Comunidade Dev
